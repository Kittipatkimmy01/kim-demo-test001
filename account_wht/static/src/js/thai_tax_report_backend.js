odoo.define("ctp_thai_tax_report_backend", function (require) {
    "use strict";
    ...
    var report_backend = AbstractAction.extend({
        ...
        events: {
            "click .o_ctp_thai_tax_report_print": "print",
            "click .o_ctp_thai_tax_report_export": "export",
        },
    ...
    core.action_registry.add("ctp_thai_tax_report_backend", report_backend);
